...
/** Runs before paint: localStorage → default dark (no key) → optional embed URL override. */
export const THEME_INIT_SCRIPT = `(function(){try{var k=${JSON.stringify(
  THEME_STORAGE_KEY
)};var s=localStorage.getItem(k);var dark;if(s==="dark")dark=true;else if(s==="light")dark=false;else dark=true;if(dark)document.documentElement.classList.add("dark");else document.documentElement.classList.remove("dark");var q=location.search||"";if(q.indexOf("embed=1")!==-1){if(q.indexOf("theme=dark")!==-1)document.documentElement.classList.add("dark");else if(q.indexOf("theme=light")!==-1)document.documentElement.classList.remove("dark");}}catch(e){}})();`;
