/**
 * Citizen homepage preview — compact market card (iframe) + click-through to partner full page.
 *
 * Homepage (BitChute):
 * <div
 *   id="citizen-market-card"
 *   data-market-id="covid19"
 *   data-click-url="https://markets.your-bitchute-site.example/covid19"
 *   data-theme="dark"
 * ></div>
 * <script src="https://www.thecitizen.io/widget-card.js" async></script>
 *
 * Full market page on partner domain should embed the normal full widget (`widget.js`) or an iframe to:
 *   /markets/<marketId>?embed=1&theme=...
 *
 * Optional attributes:
 * - data-base-url: Citizen origin for the iframe (default: origin of this script)
 * - data-api-base-url: Origin used to fetch `/api/odds-history` when the iframe host has no data (local dev)
 * - data-theme: light|dark
 * - data-min-height, data-height, data-title
 *
 * Multiple cards: use [data-citizen-market-card] on each container.
 */
(function () {
  "use strict";
